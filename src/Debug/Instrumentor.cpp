...
// ==============================================================
// Begin/End session instrumentation
// ==============================================================
...
// ==============================================================
    ...
    void InstrumentationTimer::Stop()
    {
        ...
        auto elapsedTime = std::chrono::duration_cast<std::chrono::microseconds>(endTimepoint - m_StartTimepoint).count();
        ...
        Instrumentor::Get().WriteProfile({m_Name, startTime, elapsedTime, threadID});
        m_Stopped = true;
    }
